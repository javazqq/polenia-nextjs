...
import { Menu, X, Home, Info, Mail, MessageCircleQuestion, ShoppingCart } from 'lucide-react';
...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { href: '/cart', label: 'Cart', icon: ShoppingCart, scroll: false, showCount: true },
  ];
  ...
  <Link href={href} scroll={scroll ?? true} className="hover:text-yellow-300 flex items-center">
    {label}
  </Link>
)}
