  ...
  return (
    <div className="bg-[#F8F4FF] relative overflow-hidden">
      ...
      <div className="relative overflow-hidden">
        <section className="bg-gradient-to-tr from-[#FFFBF4] via-[#F8F4FF] to-[#E8E1FF] min-h-screen flex items-center relative py-12 md:py-20">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="text-center lg:text-left space-y-6 lg:space-y-8">
              ...
              {/* Features badges */}
              <div className="flex flex-wrap justify-center lg:justify-start gap-3 opacity-0 animate-fade-in-right [animation-delay:450ms]">
              ...
              <div className="flex flex-col sm:flex-row gap-4 opacity-0 animate-fade-in-right [animation-delay:600ms] justify-center lg:justify-start">
                <a href="/products" className="group"></a>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-[#FFFBF4] to-[#F8F4FF]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12 md:mb-16">
            {/* Process Step 1 */}
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-white/40 shadow-lg hover:shadow-xl transition-shadow duration-300">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-[#F8F4FF] to-[#E8E1FF]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 max-w-4xl mx-auto">
            {/* Team Member 1 */}
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-white/40 shadow-lg hover:shadow-xl transition-shadow duration-300 text-center">
