...
export default function Dashboard() {
    ...
    return (
        ...
        >
            ...
            This is your dashboard where you can manage your content, view analytics, and customize your experience.
            </p>
            </motion.div>
            </section>
        ...
        <ul className="divide-y">
          {users.map(user => (
            <li key={user.id} className="py-3 flex justify-between flex-col sm:flex-row sm:items-center">
              <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {['name', 'description', 'price', 'image', 'countInStock'].map((field) => (
            <input
              key={field}
              ...
              className="border border-yellow-300 px-3 py-2 rounded-md focus:ring-2 focus:ring-yellow-500"
            />
          ))}
          <div className="col-span-full flex justify-end">
            <button
              onClick={handleCreateProduct}
              className="bg-yellow-800 text-white px-6 py-2 rounded-md hover:bg-yellow-900"
            >
              Create Product
            </button>
          </div>
       ...
       <section className="space-y-6">
        <h2 className="text-2xl font-semibold text-yellow-800">Products</h2>
        {products.map(product => (
          <div key={product.id} className="bg-white rounded-2xl shadow p-5 border border-yellow-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="col-span-full flex gap-3 mt-2">
                  <button
                    ...
                    className="bg-yellow-800 text-white px-4 py-2 rounded-md hover:bg-yellow-900"
                  >
                    Save
                  </button>
                  <button
                    onClick={() => setEditingProductId(null)}
                    className="bg-gray-100 text-yellow-800 px-4 py-2 rounded-md hover:bg-gray-200"
                  >
                    Cancel
                  </button>
                </div>
  ...
  <div className="flex flex-col sm:items-start">
    ...
    <p className="text-sm text-yellow-700 mt-1">${product.price.toFixed(2)}</p>
  </div>
