      ...
      <div className="max-w-5xl mx-auto text-center space-y-12">
        <section>
          ...
          >
            ...
            <p className="text-xl text-yellow-800 leading-relaxed">
              This is your dashboard where you can manage your content, view
              analytics, and customize your experience.
            </p>
          </motion.div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {["name", "description", "price", "image", "countInStock"].map(
              (field) => (
                <input
                  key={field}
                  type={
        ...
        <section className="space-y-6">
          ...
          {products.map((product) => (
            <div
              key={product.id}
              className="bg-white rounded-2xl shadow p-5 border border-yellow-100"
            >
